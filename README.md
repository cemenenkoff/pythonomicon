...
- [2. Environment Setup <img height=25 src="img/readme/windows-logo.png" style="vertical-align: bottom;"/>](#2-environment-setup)
   * [2.1 Python <img height=25 src="img/readme/python-logo.webp" style="vertical-align: bottom;"/>](#21-python)
   * [2.2 Git Bash  <img height=25 src="img/readme/git-bash-logo.png" style="vertical-align: bottom;"/>](#22-git-bash)
   * [2.3 Notepad++ <img height=30 src="img/readme/notepad-logo.png" style="vertical-align: bottom;"/>](#23-notepad)
   * [2.4 VS Code <img height=25 src="img/readme/vs-code-logo.png" style="vertical-align: bottom;"/>](#24-vs-code)
